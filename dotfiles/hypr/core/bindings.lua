...
bind("ALT + TAB", "Cycle next window", hl.dsp.window.cycle_next())
bind("ALT + SHIFT + TAB", "Cycle previous window", hl.dsp.window.cycle_next({ next = false }))
...
-- Dynamic CTRL+N/P: only intercept when helium is focused.
